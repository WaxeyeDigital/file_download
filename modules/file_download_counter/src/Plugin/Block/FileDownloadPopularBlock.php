...
class FileDownloadPopularBlock extends BlockBase {
  ...
  public function blockForm($form, FormStateInterface $form_state) {
    ...
    $form['file_download_counter_block_top_day_num'] = array(
     '#type' => 'select',
    ...
    $form['file_download_counter_block_top_all_num'] = array(
      '#type' => 'select',
    ...
    $form['file_download_counter_block_top_last_num'] = array(
      '#type' => 'select',
